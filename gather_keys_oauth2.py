...
class OAuth2Server:
    ...
    def browser_authorize(self):
        ...
        cherrypy.config.update({'server.socket_host': urlparams.hostname,
                                ...
                                'server.ssl_certificate': '/Users/scott.nusbaum/.ssh/https_cert.pem',
                                'server.ssl_private_key': '/Users/scott.nusbaum/.ssh/https_key.pem',
    ...
    def index(self, state, code=None, error=None):
        ...
        if code:
            try:
                print(self.fitbit.client.fetch_access_token(code))
